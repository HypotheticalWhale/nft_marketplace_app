...
export const NFTTitle = ({title, subtitle, titleSize, subtitileSize}) => {
  return (
    <View>
      <Text
        style={{
...
const EndDate = () => {
  return (
      ...
      <Text style={{fontFamily:FONTS.semiBold,fontSize:SIZES.medium,colors:COLORS.primary}}>12h 30m</Text>
